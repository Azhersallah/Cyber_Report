...
export const translations: Record<string, Record<Language, string>> = {
  ...
  // Header
  'nav.photos': { en: 'Cyber Report', ku: 'سایبەر ڕاپۆرت', ar: 'تقرير سايبر' },
  ...
  'layout.3grid': { en: '3 Photos (Grid)', ku: '٣ وێنە (تۆڕ)', ar: '٣ صور (شبكة)' },
  'layout.4': { en: '4 Photos', ku: '٤ وێنە', ar: '٤ صور' },
  'layout.8': { en: '8 Photos', ku: '٨ وێنە', ar: '٨ صور' },
  'layout.9': { en: '9 Photos', ku: '٩ وێنە', ar: '٩ صور' },
  'layout.custom': { en: 'Custom Grid', ku: 'تۆڕی کەستم', ar: 'شبكة مخصصة' },
  'settings.customCols': { en: 'Grid Columns', ku: 'ستوونەکانی تۆڕ', ar: 'أعمدة الشبكة' },
  'settings.customRows': { en: 'Grid Rows', ku: 'دێڕەکانی تۆڕ', ar: 'صفوف الشبكة' },
  'layout.1text': { en: '1 Photo + 1 Text', ku: '١ وێنە + ١ دەق', ar: '١ صورة + ١ نص' },
  'layout.1text-side': { en: '1 Photo + 1 Text', ku: '١ وێنە + ١ دەق', ar: '١ صورة + ١ نص' },
  'layout.2text': { en: '2 Photos + 2 Texts', ku: '٢ وێنە + ٢ دەق', ar: '٢ صور + ٢ نصوص' },
  'layout.2text1': { en: '2 Photos + 1 Text', ku: '٢ وێنە + ١ دەق', ar: '٢ صور + ١ نص' },
  'layout.2text1-side': { en: '2 Photos + 1 Text', ku: '٢ وێنە + ١ دەق', ar: '٢ صور + ١ نص' },
  ...
  'btn.addPage': { en: 'Add Page', ku: 'زیادکردنی پەڕە', ar: 'إضافة صفحة' },
  'toast.pageAdded': { en: 'New page successfully added', ku: 'پەڕەی نوێ بە سەرکەوتوویی زیادکرا', ar: 'تم إضافة صفحة جديدة بنجاح' },
  'toast.pageDeleted': { en: 'Page successfully deleted', ku: 'پەڕەکە بە سەرکەوتوویی سڕایەوە', ar: 'تم حذف الصفحة بنجاح' },
